  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-r from-sageGreen to-beige p-6 flex flex-col items-center justify-center">
        <h1 className="text-4xl font-semibold text-charcoal mb-6">Loading...</h1>
        <div className="text-lg text-charcoal">Please wait while we fetch your data</div>
      </div>
    );
  }
    ...
    <div className="relative min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 p-6 flex flex-col items-center text-center">
        ...
        {error ? (
          ...
          <div className="bg-white bg-opacity-60 p-6 rounded-xl shadow-lg w-full max-w-3xl">
